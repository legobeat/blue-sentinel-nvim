...
local function on_text(args)
  ...
  elseif decoded[1] == MSG_TYPE.AVAILABLE then
  ...
  elseif decoded[1] == MSG_TYPE.CONNECT then
  ...
  elseif decoded[1] == MSG_TYPE.DISCONNECT then
...
function handle_text(args)
  local decoded = args.decoded
  local app_state = args.app_state
